...
public class ContactsListCellRender extends javax.swing.JPanel implements ListCellRenderer<Object> {
    ...
    private void initComponents() {
        ...
        statusLabel.setIcon(new javax.swing.ImageIcon(getClass().getResource("/resources/gary.PNG"))); // NOI18N
        ...
        if (value instanceof UserAccount) {
            ...
            switch (account.getStatus()) {
                ...
                case UserAccount.BUSY:
                    ...
                    break;
                default:
                    imageIcon = new ImageIcon(getClass().getResource("/resources/gary.PNG"));
            }
